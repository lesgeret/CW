...
window.onload = function () {
    ...
    $('.pod-grid').each(function () {     /* выделяем слайдер в блоке Товар дня */
        ...
        $('.slider-nav', this).slick({
            ...
            focusOnSelect: true,
            prevArrow: '<img class="slider-arrow-prev" src="lesgeret.github.io/CW/img/arr-next.png" alt="asasa">',
            nextArrow: '<img class="slider-arrow-next" src="lesgeret.github.io/CW/img/arr-prev.png" alt="asasa">',
            ...
            responsive: [
                {
                    ...
                    settings: {
                        ...
                        prevArrow: '<img class="slider-arrow-prev" src="lesgeret.github.io/CW/img/arr-hor-prev.png" alt="asas">',
                        nextArrow: '<img class="slider-arrow-next" src="lesgeret.github.io/CW/img/arr-hor-next.png" alt="asas">',
                    }
                }]
        });
